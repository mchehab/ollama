...
func (m *ggmlTQCompressedK) EnsureLayer(layer, capacity int) {
	...
	// WHT rotation adds 1 (signs vector).
	ctxHint := 2
	if m.hasOutliers() {
		ctxHint += 3
	}
...
func (m *ggmlTQCompressedK) GetAsTQTensor(ctx ml.Context, layer int, encodeResult ml.Tensor, firstCell, nCells int) (ml.Tensor, bool) {
	return m.getAsTQTensorInternal(layer, encodeResult, firstCell, nCells, nil)
}
...
func (m *ggmlTQCompressedK) GetAsTQTensorAt(ctx ml.Context, layer int, encodeResult, locs ml.Tensor) (ml.Tensor, bool) {
	...
	nCells := locs.Shape()[0]
	return m.getAsTQTensorInternal(layer, encodeResult, 0, nCells, locs)
}

func (m *ggmlTQCompressedK) getAsTQTensorInternal(layer int, encodeResult ml.Tensor, firstCell, nCells int, locs ml.Tensor) (ml.Tensor, bool) {
...
func (m *ggmlTQCompressedK) GetAsTQTensorKV(ctx ml.Context, layer int, kEncodeResult, vEncodeResult ml.Tensor, firstCell, nCells int) (ml.Tensor, bool) {
	return m.getAsTQTensorKVInternal(layer, kEncodeResult, vEncodeResult, firstCell, nCells, nil)
}
...
func (m *ggmlTQCompressedK) GetAsTQTensorKVAt(ctx ml.Context, layer int, kEncodeResult, vEncodeResult, locs ml.Tensor) (ml.Tensor, bool) {
	...
	nCells := locs.Shape()[0]
	return m.getAsTQTensorKVInternal(layer, kEncodeResult, vEncodeResult, 0, nCells, locs)
}

func (m *ggmlTQCompressedK) getAsTQTensorKVInternal(layer int, kEncodeResult, vEncodeResult ml.Tensor, firstCell, nCells int, locs ml.Tensor) (ml.Tensor, bool) {
	if !m.fusedKernelSupports() {
		return nil, false
	}
